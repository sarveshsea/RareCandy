...
def run_test():
    print("💎 Running Rare Candy Deterministic Replay Test...")
    ...
    if signal:
        ...
        if decision.approved:
            print(f"✅ Risk Approved: {decision.quantity} units (${decision.notional:.2f})")
        else:
            print(f"❌ Risk Blocked: {decision.reason}")
    else:
        print("❌ No Signal Generated by Strategy (Synthetic data may need tuning)")
        ...
        if decision.approved:
            print(f"✅ Risk System Verified: Approved manual signal. {decision.quantity} units.")
        else:
            print(f"❌ Risk System Verified: Blocked manual signal. Reason: {decision.reason}")
